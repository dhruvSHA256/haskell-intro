...
-- Do not add argument on the left hand side of function definition.
-- Implement it using . operator in a way that don't require it.
--
-- Examples:
--
...
-- for 'goDirs'. It should still succeed, but have noticable memory
-- use.
--
-- Examples:
--
